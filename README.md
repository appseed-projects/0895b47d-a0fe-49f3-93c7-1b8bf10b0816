...
- Timestamp: `2022-06-16 06:25`
- Build ID: `0895b47d-a0fe-49f3-93c7-1b8bf10b0816`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0895b47d-a0fe-49f3-93c7-1b8bf10b0816.git
$ cd 0895b47d-a0fe-49f3-93c7-1b8bf10b0816
```
